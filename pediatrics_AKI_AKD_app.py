...
# User selects which content to display
    ...
    # Feature input
        ...
        if prediction_type == "AKI Prediction":
            ...
            scr_last = st.number_input("Scr (μmol/L)", value=0.00, format="%.2f") 
        ...
        # Map AKIGrade back to 0, 1, 2, 3 for prediction
            ...
            features.extend([scr_last, WBC, Neutrophil, LDH,Hypnotics_and_sedatives_encoded, PTA, MCHC, P, TP, RBC])
        else:
            ...
            AKI_Grade=st.selectbox("AKI Grade", ["Stage 0", "Stage 1", "Stage 2", "Stage 3"])
